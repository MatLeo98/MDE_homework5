...
public class WebFactoryImpl extends EFactoryImpl implements WebFactory {
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case WebPackage.WEB_APP: return createWebApp();
			case WebPackage.TABLE: return createTable();
			case WebPackage.COLUMN: return createColumn();
			case WebPackage.NAMED_ELEMENT: return createNamedElement();
			case WebPackage.INDEX: return createIndex();
			case WebPackage.PAGE: return createPage();
			case WebPackage.INDIVIDUAL: return createIndividual();
			case WebPackage.LINK: return createLink();
			case WebPackage.CONTENT: return createContent();
			default:
