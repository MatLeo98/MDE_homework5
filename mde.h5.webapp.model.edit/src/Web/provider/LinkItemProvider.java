...
/**
 * This is the item provider adapter for a {@link Web.Link} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class LinkItemProvider 
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Link_individual_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Link_individual_feature", "_UI_Link_type"),
				 WebPackage.Literals.LINK__INDIVIDUAL,
				 true,
				 false,
				 true,
				 null,
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebPackage.Literals.LINK__NAME,
				 true,
				 false,
				 false,
	...
	public ResourceLocator getResourceLocator() {
		return MyAppEditPlugin.INSTANCE;
	}
