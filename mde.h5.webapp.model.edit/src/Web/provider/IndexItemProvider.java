...
/**
 * This is the item provider adapter for a {@link Web.Index} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class IndexItemProvider extends NamedElementItemProvider {
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebPackage.Literals.INDEX__TABLE,
				 true,
				 false,
				 true,
				 null,
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WebPackage.Literals.INDEX__INDIVIDUALS);
			childrenFeatures.add(WebPackage.Literals.INDEX__LINKS);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WebPackage.Literals.INDEX__INDIVIDUALS,
				 WebFactory.eINSTANCE.createIndividual()));

		newChildDescriptors.add
			(createChildParameter
				(WebPackage.Literals.INDEX__LINKS,
				 WebFactory.eINSTANCE.createLink()));
	}
