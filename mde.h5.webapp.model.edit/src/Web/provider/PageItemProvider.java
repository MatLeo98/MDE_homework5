...
/**
 * This is the item provider adapter for a {@link Web.Page} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
public class PageItemProvider extends NamedElementItemProvider {
	...
	public Collection<? extends EStructuralFeature> getChildrenFeatures(Object object) {
		if (childrenFeatures == null) {
			...
			childrenFeatures.add(WebPackage.Literals.PAGE__INDIVIDUAL);
			childrenFeatures.add(WebPackage.Literals.PAGE__LIST);
		}
	...
	protected void collectNewChildDescriptors(Collection<Object> newChildDescriptors, Object object) {
		...
		newChildDescriptors.add
			(createChildParameter
				(WebPackage.Literals.PAGE__INDIVIDUAL,
				 WebFactory.eINSTANCE.createIndividual()));

		newChildDescriptors.add
			(createChildParameter
				(WebPackage.Literals.PAGE__LIST,
				 WebFactory.eINSTANCE.createIndex()));
	}
