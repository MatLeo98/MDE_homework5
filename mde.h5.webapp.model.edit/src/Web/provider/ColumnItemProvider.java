...
/**
 * This is the item provider adapter for a {@link Web.Column} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 WebPackage.Literals.COLUMN__TYPE,
				 true,
				 false,
				 false,
	...
	protected void addIsPKPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Column_isPK_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Column_isPK_feature", "_UI_Column_type"),
				 WebPackage.Literals.COLUMN__IS_PK,
				 true,
				 false,
				 false,
